...
;; Clojure code for solving knapsack problems with a genetic algorithm
;; Lee Spector (lspector@amherst.edu) 20200209

;; The top-level call function, evolve-knapsack, takes:
...
#_(evolve-knapsack 10 10 20 [1 4 4 4 4 5 30 40 50 60])

;; A test on a larger, randomly-generated problem:
#_(let [object-sizes (repeatedly 20 #(inc (rand-int 100)))
...
#_(read-string (str "[" (slurp "data.txt") "]"))

;; And process it like this
#_(let [data (read-string (str "[" (slurp "data.txt") "]"))]
